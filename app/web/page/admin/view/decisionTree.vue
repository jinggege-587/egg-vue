                ...
                */
                ...
                const registerFn = () => {
                    ...
                    G6.registerNode(
                        ...
                        shapeType: 'flow-rect',
                        draw(cfg, group) {
                            const { name = '',image, wife, des, lightColor, hasChildren, label, rate, collapsed } = cfg;
                            // 逻辑不应该在这里判断
                            const rectConfig = {
                                width: 184,
                                height: 74,
                            ...
                            group.addShape('image', {
                                attrs: {
                                    ...
                                    height: 20,
                                    // img: image,
                                    img: image || 'https://g.alicdn.com/cm-design/arms-trace/1.0.155/styles/armsTrace/images/TAIR.png',
